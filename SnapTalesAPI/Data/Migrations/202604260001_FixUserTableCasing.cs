...
namespace SnapTalesAPI.Data.Migrations
{
    ...
    public class FixUserTableCasing : Migration
    {
        public override void Up()
        {
            // Drop old snake_case table created during initial dev testing
            Execute.Sql(@"DROP TABLE IF EXISTS public.users CASCADE");
            Execute.Sql(@"DROP TABLE IF EXISTS public.""Users"" CASCADE");
